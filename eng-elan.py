...
def create_tier(output, transcriptions, level, threshold, tier):
...
def main():
    ...
    if params['tier'] != "":
        ...
        create_tier(params['output_segments'], audios,
                    params['level'], params['threshold'], params['tier'])
        ...
        # now we add them to the eaf file within the chosen tier
        create_tier(params['output_segments'], transcriptions, params['level'], params['threshold'], params['tier'])
